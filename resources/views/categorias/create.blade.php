        ...
        <div class="w-full">
            ...
            <div class="windowsize mt-10 ">
                ...
                <form class="bg-white m-auto flex flex-col w-[500px] p-10 border shadow-md" id="create" role="form">
                    ...
                    <button id="submit" type="submit" class="hover:cursor-pointer m-auto text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md w-full sm:w-auto px-5 py-2.5 text-center">Criar</button>
                </form>
